...
dimension_. Anyone reaching for a dimension estimate as evidence is measuring the wrong invariant. The right
invariants are:
...
\(\ln\ln\sqrt N - \ln\ln p_w\) of `paper.md` §4.5 _is_ the accumulated error of that truncation, and its \(\ln\ln\)
